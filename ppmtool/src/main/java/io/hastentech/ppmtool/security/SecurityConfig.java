...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	@Autowired
	private BCryptPasswordEncoder bCryptPasswrodEncoder;
	...
	protected void configure(AuthenticationManagerBuilder authenticationManagerBuilder) 
		...
		authenticationManagerBuilder.userDetailsService(customUserServiceDetails).passwordEncoder(bCryptPasswrodEncoder);
	}
